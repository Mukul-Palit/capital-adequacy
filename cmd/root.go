...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.capital-adequacy.yaml)")
...
func initConfig() {
	...
	viper.SetConfigName(".capital-adequacy") // name of config file (without extension)
